                    ...
                    <ContentTemplate>
                        ...
                        <div >
                            ...
                            <div class="row divmargin">
                                <div class="col-sm-12">
                                    <asp:Label ID="Label1" runat="server" CssClass="shiaraititleStyle txt-style" Text="大分類 ：" />
                            ...
                            <div id="Gvdiv" runat="server" style="overflow: auto; width: 450px;max-height:380px;height:auto; margin-bottom: 3px; margin-top: 5px;">
                                                    ...
                                                    <table style="margin-left: 10px; width: 100%;">
                                                        <tr>
                                                            <td style="width: 240px;">
                                                                <asp:TextBox ID="txt_editChuu" runat="server" Text='<%# Bind("sSYOUHIN_TYUUGRP") %>' Width="240px" CssClass="form-control TextboxStyle"></asp:TextBox>

                                                            </td>
                                                            <td style="padding-left: 10px">
                                                                <asp:Button ID="btnUpdate" runat="server" Style="font-size: 13px;" Text="更新" CssClass="JC10GrayButton" OnClick="btnUpdate_Click" />
                                                                <asp:Button ID="btnEditCancel" runat="server" Text="キャンセル" CssClass="JC07HyojiItemSettingBtn" Style="margin-left: 3px; font-size: 13px;" OnClick="btnEditCancel_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                            ...
                            <div id="newDiv" class="row " style="visibility: hidden" runat="server">
                                <%-- --%>
                                <table style="margin: 3px 0px 3px 0px;">
                                    <tr>
                                        <td style="width: 240px">
                                            <asp:TextBox ID="txt_newChuubunrui" runat="server" Text='' MaxLength="50" Width="240px" CssClass="form-control TextboxStyle"></asp:TextBox><%--OnTextChanged="txt_newChuubunrui_TextChanged"--%>

                                        </td>
                                        <td style="padding-left: 10px">
                                            <asp:Button ID="btnnewChuubunruiSave" runat="server" Text="保存" CssClass="JC10GrayButton" OnClick="btnnewChuubunruiSave_Click" />
