    ...
    margin-right: auto;
        ...
        <body id="BD_Syouhin" runat="server" style="background-color: #d7e4f2 !important;">
            ...
            <ContentTemplate>
               ...
               <%-- <div class="JC37TableWidth" id="div1" runat="server">
                    <nav id="nav3" runat="server" class="navbar-expand custom-navbar1 custom-navbar-height" style="position: absolute;">
                        <div class="collapse navbar-collapse JC09navbar JC37TableWidth" id="Div6" runat="server">
                            <label style="font-weight: bold; font-size: 14px;text-align: center; display: inline-block;">商品</label>
                ...
                <div id="Div_Body" runat="server" class="" style="background-color:#d7e4f2;min-height: 100%;">
        <div class="JC37SyouhinTourokuDiv" id="divMitumoriTorokuP" runat="server" style="margin-bottom:10px; margin-left: auto; margin-right: auto;  padding: 0; left: 50%; top: 50%; position: absolute; transform: translate(-50%, -50%);">
             <asp:UpdatePanel runat="server" ID="updLabelSave" UpdateMode="Conditional">
                        ...
                        <div id="divPopupHeader" runat="server" style="height:40px;">
                            <asp:Label ID="lblHeader" runat="server" Text="商品" CssClass="TitleLabel d-block align-content-left" style=""></asp:Label>
                        ...
                        <div id="DivLine" runat="server" class="Borderline"></div>
                         <%--<table runat="server" id="table" class="JC09TableWidth" align="center">--%>
                                   ...
                                   <table>
                                         ...
                                         <tr class="JC10MitumoriTourokuHeightTr3">
                                            ...
                                            <td >
                                                <asp:UpdatePanel ID="upd_Shohinryakusho" runat="server" UpdateMode="Conditional">
                                                     <ContentTemplate>
                                                        <asp:TextBox ID="TB_Shohinryakusho" runat="server" AutoPostBack="true" MaxLength="100" CssClass="form-control TextboxStyle JC37SyouhinCodeTourokuTextBox"
                                       ...
                                       <tr class="JC10MitumoriTourokuHeightTr3">
                                           ...
                                           <td class="text-left JC37SyouhinTd2" style="width:200px">
                                             ...
                                             <td colspan="2" class="text-left JC37SyouhinTd3">
                                                <asp:DropDownList ID="DD_SizeX" runat="server" Width="60px" AutoPostBack="True" Height="28px" BackColor="WhiteSmoke">
                                        ...
                                        <tr class="JC10MitumoriTourokuHeightTr3">
                                           ...
                                           <td class="text-left JC37SyouhinTd2" style="width:200px">
                                             ...
                                             <td colspan="2" class="text-left JC37SyouhinTd3">
                                                <asp:DropDownList ID="DD_SizeY" runat="server" Width="60px" AutoPostBack="True" Height="28px" BackColor="WhiteSmoke">
                                                          <asp:ListItem Value="0" Text="mm" Selected="True"></asp:ListItem>
                                                         <asp:ListItem Value="1" Text="m" ></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr class="JC10MitumoriTourokuHeightTr3">
                                           ...
                                           <td class="text-left JC37SyouhinTd2" style="width:200px">
                                             ...
                                             <td colspan="2" class="text-left JC37SyouhinTd3">
                                                <asp:DropDownList ID="DD_SizeZ" runat="server" Width="60px" AutoPostBack="True" Height="28px" BackColor="WhiteSmoke">
                                                          <asp:ListItem Value="0" Text="mm" Selected="True"></asp:ListItem>
                                                         <asp:ListItem Value="1" Text="m" ></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                     ...
                                     <tr class="JC10MitumoriTourokuHeightTr3">
                                            ...
                                            <td  class="text-left" style="">
                                                <%--<asp:UpdatePanel ID="Upd_Shiyou" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>--%>
                                                        <asp:TextBox ID="TB_Shiyou" runat="server" AutoPostBack="true" MaxLength="200" CssClass="form-control TextboxStyle JC37SyouhinMeiTourokuTextBox"
                                                            onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" ></asp:TextBox>
                                                   <%-- </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <td  class="text-left" style="">
                                                <asp:UpdatePanel ID="upd_SHIIRESAKI" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <div style="float: left; min-width: 150px;max-width: 100%; display: none;text-overflow:ellipsis;white-space: nowrap;overflow: hidden;" id="divSHIIRESAKIKensakuLabel" runat="server">
                                      ...
                                      <tr class="">
                                            ...
                                            <td class="text-left " >
                                                <%--<asp:UpdatePanel ID="updBikou" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>--%>
                                                        <asp:TextBox ID="txtBikou" MaxLength="200" AutoPostBack="true" CssClass="form-control TextboxStyle JC37SyouhinTextArea" Rows="5" runat="server" TextMode="MultiLine"
                                       ...
                                       <tr class="JC10MitumoriTourokuHeightTr3">
                                            ...
                                            <td  class="text-left" style="">
                                               <%-- <asp:UpdatePanel ID="Upd_KataBan" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>--%>
                                                        <asp:TextBox ID="TB_KataBan" runat="server" AutoPostBack="true" MaxLength="100" CssClass="form-control TextboxStyle JC37SyouhinMeiTourokuTextBox"
                                                            onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" ></asp:TextBox>
                                                  <%--  </ContentTemplate>
                                                    <Triggers>
                                       ...
                                       <tr class="JC10MitumoriTourokuHeightTr3">
                                            ...
                                            <td  class="text-left" style="">
                                                <%--<asp:UpdatePanel ID="Upd_Meka" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>--%>
                                                        <asp:TextBox ID="TB_Meka" runat="server" AutoPostBack="true" MaxLength="100" CssClass="form-control TextboxStyle JC37SyouhinMeiTourokuTextBox"
                                                            onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" ></asp:TextBox>
                                                   <%-- </ContentTemplate>
                                                    <Triggers>
