                ...
                <div style="max-width: 1160px; background-color: white; margin-left: auto; margin-right: auto; padding: 0; left: 50%; top: 50%; position: absolute; transform: translate(-50%, -50%);">
                    ...
                    <div style="margin: 15px 20px 20px 20px;">
                        ...
                        <div style="overflow-x: auto; width: 100% !important;">
                                <div style="background-color: white; width: auto;height: 424px; overflow-y: auto; overflow-x: auto;" display: inline-block !important;">
                            <asp:GridView ID="dgShiire" runat="server" BorderColor="Transparent" AutoGenerateColumns="false" EmptyDataRowStyle-CssClass="JC18NoDataMessageStyle" EmptyDataText="該当するデータがありません。" HtmlEncode="false"
                                        ...
                                        <ItemTemplate>
                                            <div class="grip" style="text-align: left; width: 25px; padding-right: 4px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; word-break: break-all;">
                                                ...
                                                <asp:Panel ID="PopupMenu1" runat="server" CssClass="modalPopup dropdown-menu fontcss " aria-labelledby="dropdownMenuButton" Style="display: none; min-width: 1rem; width: 6rem; margin-left: 5px;">
                                                    <asp:LinkButton ID="lnkbtnShiireEdit" class="dropdown-item" runat="server" Text='編集' Style="margin-right: 10px" OnClick="lnkbtnShiireEdit_Click"></asp:LinkButton>
                                                    <asp:LinkButton ID="lnkbtnShiireDelete_Click" class="dropdown-item" runat="server" Text='削除' Style="margin-right: 10px" OnClick="lnkbtnShiireDelete_Click_Click"></asp:LinkButton>
                                                </asp:Panel>
