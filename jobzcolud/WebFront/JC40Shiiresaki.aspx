                    ...
                    <table runat="server" id="table" align="center">
                        <tr>
                            <td id="td1" runat="server" style="width: 100%">
                                <asp:Panel runat="server" ID="PanelSyousai" Style="height: 580px;" CssClass="JC40TableWidth">
                                    <div style="height: 830px; background-color: white;">
                                        <table style="border: none; background-color: white;" class="JC40TableWidth">
                                            <tr>
                                                <td class="auto-style2">
                                                    <div runat="server" id="divLabelSyousai" style="border-style: none; border-color: inherit; border-width: medium; display: inline-block; margin-top: 14px; margin-left: -6px;">

                                                        <div id="div_leftSyousai" style="width: 550px; height: 350px; float: left;margin-left:50px;">

                                                             <table style="margin-top: 20px; margin-bottom: 10px;">
                                                                <tr style="height: 60px;">
                                                                    <td style="width: 30px; height: 40px;"></td>
                                                                    <td>
                                                                        <asp:Button runat="server" ID="BT_Save" Text="仕入先を保存" type="button " CssClass="BlueBackgroundButton JC10SaveBtn" Style="margin-left: 20px !important;" OnClick="BT_Save_Click" />
                                                                    </td>
                                                                     <td>
                                                             ...
                                                             <table>
                                                                <tr style="height: 40px;">
                                                                    ...
                                                                    <td valign="top" style="height: 40px; padding-top: 6px;">
                                                                        <asp:Label runat="server" ID="LB_ShiresakiCode" Style="margin-right: 40px; display: block;"></asp:Label>
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr style="height: 40px;">
                                                        ...
                                                        <div id="div_rightSyousai" style="height: 350px; float: right;margin-left:50px;">
                                                            <table>
                                                                <tr style="height: 70px;">
                                                                    <td style="align-content: center; " class="auto-style1">
                                                                        <label style="font-weight: bold; margin-top: 10px; font-size: 14px;">仕入オプション</label></td>
                                                                </tr>
                                                                <tr style="height: 40px;">
                                                                    ...
                                                                    <td style="vertical-align: top;">
                                                                        <asp:UpdatePanel ID="updShimebi" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_shimebi" runat="server" Width="90px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl2" OnSelectedIndexChanged="DDL_shimebi_SelectedIndexChanged"> 
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="auto-style1">
                                                                        <asp:UpdatePanel ID="updkihonshiharai" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_kihonshiharai" runat="server" Width="150px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl" OnSelectedIndexChanged="DDL_kihonshiharai_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                    <td style="width: 90px;">
                                                                        <asp:TextBox runat="server" ID="TB_kihonvalue" type="text" name="txtname" Text="0" Width="60px" Height="30px" autocomplete="off" CssClass="form-control TextboxStyle JC40ddl1" AutoPostBack="True" MaxLength="3" onkeypress="return isNumberKey(event)" onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" OnTextChanged="TB_kihonvalue_TextChanged"></asp:TextBox>
                                                                ...
                                                                <tr style="height: 40px;">
                                                                    <td class="auto-style1">
                                                                        <asp:UpdatePanel ID="updkihonshiharai1" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_kihonshiharai1" runat="server" Width="150px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl" OnSelectedIndexChanged="DDL_kihonshiharai1_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                    <td style="width: 90px;">
                                                                        <asp:TextBox runat="server" ID="TB_kihonvalue1" type="text" name="txtname" Text="0" Width="60px" Height="30px" autocomplete="off" CssClass="form-control TextboxStyle JC40ddl1" AutoPostBack="True" MaxLength="3" onkeypress="return isNumberKey(event)" onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" OnTextChanged="TB_kihonvalue1_TextChanged"></asp:TextBox>
                                                                ...
                                                                <tr style="height: 40px;">
                                                                    ...
                                                                    <td style="width: 200px;">
                                                                        <asp:TextBox runat="server" ID="TB_TekiyoJouken" type="text" name="txtname" Text="100" Width="100px" Height="30px" autocomplete="off" CssClass="form-control TextboxStyle JC40ddl1" AutoPostBack="True" MaxLength="9" onkeypress="return isNumberKey(event)" onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" OnTextChanged="TB_TekiyoJouken_TextChanged"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr style="height: 40px;">
                                                                    <td class="auto-style1">
                                                                    ...
                                                                    <td style="width: 200px;">
                                                                        <asp:UpdatePanel ID="updyan" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_Yan" runat="server" Width="150px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl2" OnSelectedIndexChanged="DDL_Yan_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                ...
                                                                <tr style="height: 40px;">
                                                                    <td class="auto-style1">
                                                                        <asp:UpdatePanel ID="updkakuchoshiharai" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_kakuchoshiharai" runat="server" Width="150px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl" OnSelectedIndexChanged="DDL_kakuchoshiharai_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                    <td style="width: 90px;">
                                                                        <asp:TextBox runat="server" ID="TB_kakuchovalue" type="text" name="txtname" Text="0" Width="60px" Height="30px" autocomplete="off" CssClass="form-control TextboxStyle JC40ddl1" AutoPostBack="True" MaxLength="3" onkeypress="return isNumberKey(event)" onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" OnTextChanged="TB_kakuchovalue_TextChanged"></asp:TextBox>
                                                                ...
                                                                <tr style="height: 40px;">
                                                                    <td class="auto-style1">
                                                                        <asp:UpdatePanel ID="updkakuchoshiharai1" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="DDL_kakuchoshiharai1" runat="server" Width="150px" AutoPostBack="True" Height="30px" CssClass="form-control TextboxStyle JC40ddl" OnSelectedIndexChanged="DDL_kakuchoshiharai1_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                    <td style="width: 90px;">
                                                                        <asp:TextBox runat="server" ID="TB_kakuchovalue1" type="text" name="txtname" Text="0" Width="60px" Height="30px" autocomplete="off" CssClass="form-control TextboxStyle JC40ddl1" AutoPostBack="True" MaxLength="3" onkeypress="return isNumberKey(event)" onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" OnTextChanged="TB_kakuchovalue1_TextChanged"></asp:TextBox>
                        ...
                        <tr style="height: 30px;background-color: white;">
                            <td><label style ="margin-left: 80px;font-weight:bold;font-size:14px;" >仕入先担当者</label></td>
                        </tr>
                        <tr style="background-color: white;">
                        <td class="JC40TableWidth">
                            <div id="DIV_GV" runat="server" style="margin-left: 80px; padding-right: 10px;" >
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="GV_ShiiresakiMaster" runat="server" GridLines="Horizontal" CellPadding="4" BorderStyle="none" EnableTheming="True" BorderColor="Transparent"
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    ...
                                                    <HeaderStyle CssClass="JC18HeaderCol AlignRight" BorderColor="White" BorderWidth="2px" />
