...
function parentButtonClick(btnHome, value) {
    ...
    if (value == "Popup") {
        ...
        var btnId = 'MainContent_' + btnHome;
    }
...
/* return      : なし                                       */
/************************************************************/
function DeleteConfirmMessage(msg, btnId) {
...
/* return      : なし                                       */
/************************************************************/
function DeleteConfirmBox(message,btnDeleteYes) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
        title: "見えるJOBZ",
        ...
        buttons: [{
            text: "OK",
            "class": 'BlueBackgroundButton',
            width: 100,
            height: 30,
            click: function () {
                $(this).dialog("close");
                document.getElementById(btnDeleteYes).click();
            }
        },
        {
            text: "キャンセル",
            "class": 'JC09GrayButton',
            width: 100,
            height: 30,
            click: function () {
                $(this).dialog("close");
...
/************************************************************/
/* function    : ShowSaveChangesConfirmMessage              */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/
function ShowKoumokuChangesConfirmMessage(msg, btnYes,btnNo,btnCancel) {
    KoumokuChangeConfirmBox(msg, btnYes, btnNo, btnCancel);
    closeLoadingModal();
    return false;
}

/************************************************************/
/* function    : ShowSaveChangesConfirmBox                      */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/
function KoumokuChangeConfirmBox(message, btnYes, btnNo, btnCancel) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
/*************************************************************/
/* function    : ShowJoutaiErrorMessage                            */
/* description : エラーメッセージを表示する                  */
/* parameter   : メッセージ                                  */
/* return      : なし                                        */
/*************************************************************/
function ShowJoutaiErrorMessage(msg) {
    JoutaiAlertBox(msg);
    closeLoadingModal();
    return false;
}
...
/* return      : なし                                        */
/*************************************************************/
function JoutaiAlertBox(message) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
/*************************************************************/
/* function    : ShowErrorMessageWithWidth                   */
/* description : エラーメッセージを表示する                  */
/* parameter   : メッセージ                                  */
/* return      : なし                                        */
/*************************************************************/
function ShowErrorMessageWithWidth(msg, mWidth) {
    AlertBoxWithWidth(msg, mWidth);
    closeLoadingModal();
    return false;
}
...
/* return      : なし                                        */
/*************************************************************/
function AlertBoxWithWidth(message, mWidth) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
/*************************************************************/
/* function    : ShowMailKakuninMessage                      */
/* description : メール確認メッセージを表示する              */
/* parameter   : メッセージ                                  */
/* return      : なし                                        */
/*************************************************************/
function ShowMailKakuninMessage(msg, btnOK) {
    AlertBox(msg, btnOK);
    closeLoadingModal();
    return false;
}
...
/*************************************************************/
/* function    : MailKakuninMsgBox                           */
/* description : メール確認メッセージを表示する              */
/* parameter   : メッセージ                                  */
/* return      : なし                                        */
/*************************************************************/

function MailKakuninMsgBox(message, btnOK) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
/* return      : なし                                        */
/*************************************************************/
function ShowSuccessMessage(msg, btnOK) {
    SuccessMsgBox(msg, btnOK);
    closeLoadingModal();
    return false;
}
...
function SuccessMsgBox(message, btnOK) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
function DisableDateEntry() {
    event.returnValue = false;
}

/***************************JC28UriageList売上リスト画面_YG start*************************************/
...
/* return      : なし                                       */
/************************************************************/
function ShowMessage1(msg, btnYes1, btnNo1, btnCancel1) {
    pdfConfirmBox(msg, btnYes1, btnNo1, btnCancel1);
    closeLoadingModal();
    return false;
}

/************************************************************/
/* function    : ShowRogoMessage                            */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/
function ShowRogoMessage(msg, btnOK) {
    rogoConfirmBox(msg, btnOK);
    closeLoadingModal();
    return false;
}

/************************************************************/
/* function    : rogoConfirmBox                             */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
...
function rogoConfirmBox(message, btnOK) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
...
function pdfConfirmBox(message, btnYes1, btnNo1, btnCancel1) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
        ...
        },
        {
            ...
            click: function () {
                $(this).dialog("close");
                document.getElementById(btnNo1).click();
            }
        },
        {
            text: "キャンセル",
            ...
            click: function () {
                $(this).dialog("close");
                document.getElementById(btnCancel1).click();
            }
        }],
        create: function () {
            var buttons = $('.ui-dialog-buttonset').children('button');
...
/* function    : ShowMojiMessage                             */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/function ShowMojiMessage(msg, btnOK) {    MojiMsgBox(msg, btnOK);    closeLoadingModal();    return false;}/************************************************************/
/* function    : MojiMsgBox                                */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/function MojiMsgBox(message, btnOk) {    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({        autoOpen: false,        modal: true,        draggable: false,        title: "見えるJOBZ",        width: 480,        resizable: false,        closeOnEscape: true,        dialogClass: "custom-dialog-1",        buttons: [            {                text: "OK",                "class": 'BlueBackgroundButton',                width: 100,                height: 30,                click: function () {                    $(this).dialog("close");                    document.getElementById(btnmojiOK).click();                }            }],        create: function () {            var buttons = $('.ui-dialog-buttonset').children('button');            buttons.removeClass("ui-button ui-corner-all ui-widget");        },        close: function () {            $("#alertMessage").html("");        },        show: {}    });    $('[id$=alertMessage]').css({        "textAlign": "left",        "font-size": "13px",        "overflow": "hidden",        "text-overflow": "ellipsis",        "vertical- align": "middle",        "margin": "0.5rem 0px"    });    $('[id$=alertMessage]').html(message);    myDialog.dialog('open');}
/***************************JC28UriageList売上リスト画面_YG end*************************************/


/***************************JC38大分類画面_Nan start************************************************/
/************************************************************/
/* function    : ShowDaibunruiNullConfirmMessage            */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/
function ShowDaibunruiNullMessage(msg, btnYes, btnCancel) {
    DaibunruiConfirmBox(msg, btnYes, btnCancel);
    closeLoadingModal();
    return false;
}

/************************************************************/
/* function    : ShowDaibunruiConfirmBox                    */
/* description : 確認メッセージを表示する                   */
/* parameter   : メッセージ                                 */
/*             : 隠しボタンのID                             */
/* return      : なし                                       */
/************************************************************/
function DaibunruiConfirmBox(message, btnYes, btnCancel) {
    var myDialog = $("<div id='msgDialogAlert'><img src='../Img/info_2.png' style='width: 30px;float:left;'/><p id='alertMessage' ></p></div>").dialog({
        autoOpen: false,
        modal: true,
        draggable: false,
